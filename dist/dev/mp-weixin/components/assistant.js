        ...
        socketTask.onMessage((res) => {
          ...
          if (data.header.code === 0) {
            ...
            if (!lastMessage || lastMessage.isUser) {
              ...
              lastMessage.text += data.payload.choices.text[0].content;
            }
            chatHistoryList.value.push({
              role: "assistant",
...
GET ${httpUrlPath} HTTP/1.1`;
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: scrollTop.value,
        c: common_vendor.o((...args) => _ctx.onScroll && _ctx.onScroll(...args)),
