    ...
    setEmit(name) {
      if (!this.range) {
        ...
        if (this.hasTime && !this.time) {
          this.time = common_vendor.getTime(new Date(), this.hideSecond);
        }
      }
      let {
        year,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/vueCode/code1/okr-miniprogram/node_modules/@dcloudio/uni-ui/lib/uni-datetime-picker/calendar.vue"]]);
