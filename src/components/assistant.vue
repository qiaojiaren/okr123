...
//4.0Ultra版本
const appId = ref("3f75187f");
const apiSecret = ref("ZDNmM2U1MDAwY2FiMDI4MzZhYjI2N2Mx");
const apiKey = ref("c70275c7f674bcac88c3814100b7705e");
const domain = ref("4.0Ultra");
const httpurl = ref("https://spark-api.xf-yun.com/v4.0/chat");
const uid = ref("qjr");
...
// const apiSecret = ref("ZDNmM2U1MDAwY2FiMDI4MzZhYjI2N2Mx");
// const apiKey = ref("c70275c7f674bcac88c3814100b7705e");
// const domain = ref("lite");
// const httpurl = ref("https://spark-api.xf-yun.com/v1.1/chat");
// const uid = ref("qjr");
...
// const apiKey = ref("c70275c7f674bcac88c3814100b7705e");
// const domain = ref("lite");
// const httpurl = ref("https://maas-api.cn-huabei-1.xf-yun.com/v1.1/chat");
// const uid = ref("qjr");
...
chatHistoryList.value.push({
  role: "system",
  content:
    "以下是问题和回答，请你在回答问题的时候仔细阅读，并从中找出问题的答案，千万不要自己发散\n" +
    "问题1： 什么是OKR？\n" +
...
const sendMessage = async () => {
  showSuggestions.value = false; // 发送后隐藏提示窗口
    ...
    socketTask.onMessage((res) => {
      ...
      if (data.header.code === 0) {
        ...
        const htmlContent = marked
          .parse(data.payload.choices.text[0].content)
          .replace(/<\/?p>/g, "")
          .trim();
...
const getWebSocketUrl = () => {
  ...
  // console.log("httpUrlHost是", httpUrlHost);
  // const httpUrlPath = httpurl.value.substring(28);
  // console.log("httpUrlPath是", httpUrlPath);
  ...
  //lite版本
  // const httpUrlHost = "spark-api.xf-yun.com";
  // const httpUrlPath = "/v1.1/chat";

  //lite微调版本
  // const httpUrlHost = 'spark-api-n.xf-yun.com'
  // const httpUrlPath = '/v1.1/chat'
  ...
  return new Promise((resolve) => {
    ...
    var signatureSha = CryptoJS.HmacSHA256(signatureOrigin, apiSecret.value);
  ...
  <view class="chat-container">
    ...
    >
      <view
        ...
        :id="`item-${messages.indexOf(message)}`"
      >
        <image
          :src="message.isUser ? userAvatar : botAvatar"
          class="avatar"
          :class="{ avatarBot: !message.isUser }"
        />
