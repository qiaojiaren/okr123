...
const previewImage = flag => {
  switch (flag) {
    case 1:
      ...
      uni.previewImage({
        //urls为图片路径，是字符串数组
        urls: ["http://y4pqfi.natappfree.cc/media/static/OKR模板.png"],
      });
      break
    case 2:
      uni.previewImage({
        //urls为图片路径，是字符串数组
        urls: ["http://y4pqfi.natappfree.cc/media/static/OKR案例.png"],
      });
      break
    case 3:
      uni.previewImage({
        //urls为图片路径，是字符串数组
        urls: ["http://y4pqfi.natappfree.cc/media/static/树状图示例.png"],
      });
      break
  }
}
...
<template>
  <uni-popup ref="teamIf" type="center" :is-mask-click=false>
    <div class="card teamCard" @click="handleClose(1)">
      ...
      <img style="width: 100%;" src="http://y4pqfi.natappfree.cc/media/static/OKR案例.png" alt=""
  ...
  <uni-popup ref="errorsIf" type="center" :is-mask-click=false>
    <div class="card errorsCard" @click="handleClose(4)">
      ...
      <p class="tips">点击图片可查看大图</p>
      <img style="width: 100%;" src="http://y4pqfi.natappfree.cc/media/static/OKR模板.png" alt=""
  ...
  <uni-popup ref="personalIf" type="center" :is-mask-click=false>
    <div class="card personalCard" @click="handleClose(5)">
      ...
      <p class="tips">点击图片可查看大图</p>
      <img style="width: 100%;" src="http://y4pqfi.natappfree.cc/media/static/树状图示例.png" alt=""
  ...
  <!-- <div class="textBox">
    ...
    <view class="flexBox">
      <img class="png" src="http://y4pqfi.natappfree.cc/media/static/灯泡.png" alt="">
...
.textBox {
  ...
  background: rgba(63, 194, 237, 0.5) url(http://y4pqfi.natappfree.cc/media/static/靶子.png) no-repeat center;
}
